const projects = [
  {
    ...
    category: "Brand / Web",
    summary:
      "A story-driven landing page that uses restrained layout and strong type to keep the work front and center.",
  },
  {
    title: "Product launch page",
    category: "Campaign / Conversion",
    summary:
      "A compact marketing site with a clear value proposition, proof points, and one primary call to action.",
  },
  {
    title: "Case study system",
    category: "Content / Structure",
    summary:
      "A reusable case study format that keeps project details readable without feeling generic.",
  },
];
